...
import com.iyoho.social.scanner.camera.CameraManager;
import com.iyoho.social.scanner.common.BitmapUtils;
import com.iyoho.social.scanner.decode.BitmapDecoder;
import com.iyoho.social.scanner.decode.CaptureActivityHandler;
import com.iyoho.social.scanner.view.ViewfinderView;
...
public final class CaptureActivity extends Activity implements
    ...
    static class MyHandler extends Handler {
        ...
        public void handleMessage(Message msg) {
            if (msg.what == PARSE_BARCODE_SUC) {
                // 解析图片成功
                EventBus.getDefault().post(new MessageEvent(EventBus2Activity.class, msg.obj + ""));
                activityReference.get().finish();
            } else if (msg.what == PARSE_BARCODE_FAIL) {
                // 解析图片失败

                Toast.makeText(activityReference.get(), R.string.parsing_failure,
        ...
        if (resultCode == RESULT_OK) {
            ...
            switch (requestCode) {
                case ImageSelectorActivity.REQUEST_IMAGE:
                    String image = intent.getStringExtra(ImageSelectorActivity.REQUEST_OUTPUT);
                    Bitmap img = BitmapUtils.getCompressedBitmap(image);
    ...
    public void handleDecode(Result rawResult, Bitmap barcode, float scaleFactor) {
        ...
        EventBus.getDefault().post(new MessageEvent(EventBus2Activity.class, ResultParser.parseResult(rawResult).toString()));
    ...
    private void displayFrameworkBugMessageAndExit() {
        ...
        builder.setPositiveButton(R.string.msg_ok, new FinishListener(this));
    ...
    private void openAlbum() {
        ImageSelectorActivity.start(CaptureActivity.this, 1, ImageSelectorActivity.MODE_SINGLE, false, false, false);
    }
