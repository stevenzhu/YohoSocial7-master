 ...
 * Created by zhugongzhao on 2017/12/5.
 */
...
public class ScaleCircleNavigator extends View implements IPagerNavigator, NavigatorHelper.OnNavigatorScrollListener {
    ...
    private int smallCircleSize=3;
    private int bigCircleSize=4;
    ...
    private void init(Context context) {
        ...
        mMinRadius = UIUtil.dip2px(context, smallCircleSize);
        mMaxRadius = UIUtil.dip2px(context, bigCircleSize);
